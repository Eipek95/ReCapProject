...
@Component({
  selector: 'app-admin-color-updatee',
  templateUrl: './admin-color-updatee.component.html',
  styleUrls: ['./admin-color-updatee.component.css']
})
export class AdminColorUpdateeComponent implements OnInit {
  currentColor: Color;
  colorUpdateForm: FormGroup
  constructor(
    private updateColorModal: MatDialogRef<AdminColorUpdateeComponent>,
